        ...
        <Box w='full' mt='1.5rem' display='flex' flexDirection='column' gap='6!important'>
            <HStack w='full' gap={['6',0]} display='flex' flexDirection={['column','row']} justifyContent='space-between'>
                <VStack align='flex-start' w={['100%','50%']}>
                    ...
                    <Input placeholder='Enter your first name' id='first_name’' fontWeight='400' fontSize='16px' borderRadius='8px' border='1px solid #D0D5DD' color='#667085' />
                </VStack>
                 <VStack mt={['6','0']} align='flex-start' w={['100%','50%']}>
                    <Text fontWeight='500' fontSize='14px' color='#344054'>Last Name</Text>
                    <Input placeholder='Enter your last name' id='last_name’' fontWeight='400' fontSize='16px' borderRadius='8px' border='1px solid #D0D5DD' color='#667085' />
                </VStack>
            </HStack>
            <HStack w='full' display='flex' flexDirection={['column','row']} justifyContent='space-between'>
                <VStack align='flex-start' w={['100%','100%']}>
                    ...
                    <Input placeholder='yourname@email.com' id='email' fontWeight='400' fontSize='16px' borderRadius='8px' border='1px solid #D0D5DD' color='#667085' />
                </VStack>
            </HStack>
            <HStack w='full' display='flex' flexDirection={['column','row']} justifyContent='space-between'>
                <VStack align='flex-start' w={['100%','100%']}>
                    <Text fontWeight='500' fontSize='14px' color='#344054'>Message</Text>
                    <Textarea id='message' placeholder="Send me a message and I'll reply you as soon as possible..." fontWeight='400' fontSize='16px' borderRadius='8px' border='1px solid #D0D5DD' color='#667085' />
                </VStack>
            </HStack>
           <HStack>
            <Checkbox/>
            ...
            <Button bg='#1570EF' id='btn__submit' color='#fff' borderRadius='8px' border='1px solid #1570EF' w='100%' >Send Message </Button>
        </Box>
